...
@RestController
@RequestMapping("/otp")
public class PurplebookSMSApi {

    final DefaultMessageService messageService;

    public PurplebookSMSApi() {
        this.messageService = NurigoApp.INSTANCE.initialize("NCSUDZPZHKQ28EVQ", "FGH4AX1OGJSNRNAAGWBXUP6HF4JCC71G", "https://api.solapi.com");
    }
    ...
    public SingleMessageSentResponse sendOne() {
        ...
        message.setFrom("01031633339");
        message.setTo("01033640983");
        message.setText("PURPLE BOOK입니다.");
